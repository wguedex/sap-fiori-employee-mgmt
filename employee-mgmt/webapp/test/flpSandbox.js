		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sap fiori employee management",
									"targetURL": "#sapui5comemployeemgmt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5comemployeemgmt-display": {
								"semanticObject": "sapui5comemployeemgmt",
								"action": "display",
								"description": "Sap fiori employee management",
								"title": "Sap fiori employee management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5.com.employeemgmt",
									"url": sap.ui.require.toUrl("sapui5/com/employeemgmt")
								}
							}
						}
					}
